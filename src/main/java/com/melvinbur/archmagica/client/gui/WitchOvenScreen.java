...
public class WitchOvenScreen extends ContainerScreen<WitchOvenContainer> implements IRecipeShownListener
{
	...
	private final static ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(ArchMagica.MOD_ID, "textures/gui/smelter_gui.png");
	
	public final WitchOvenRecipeBookScreen recipeBook;
	private boolean narrow;
	
	public WitchOvenScreen(WitchOvenContainer screenContainer, PlayerInventory inv,
			ITextComponent titleIn)
	{
		super(screenContainer, inv, titleIn);
		this.recipeBook = new WitchOvenRecipeBookScreen();
	}
