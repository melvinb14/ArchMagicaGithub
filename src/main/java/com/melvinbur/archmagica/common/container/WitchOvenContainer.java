...
public class WitchOvenContainer extends RecipeBookContainer<IInventory>
{
	...
	public WitchOvenContainer(int id, PlayerInventory inventory, net.minecraft.network.PacketBuffer extraData) 
	{
		this(id, inventory, new Inventory(4), new IntArray(4));
	}
	
	public WitchOvenContainer(int syncId, PlayerInventory playerInventory, IInventory inventory, IIntArray data) 
	{
		super(ContainerTypesInit.WITCH_OVEN.get(), syncId);
		...
		this.addSlot(new OvenFuelSlot(this, inventory, 2, 56, 53));
		this.addSlot(new OvenOutputSlot(playerInventory.player, inventory, 3, 129, 35));
