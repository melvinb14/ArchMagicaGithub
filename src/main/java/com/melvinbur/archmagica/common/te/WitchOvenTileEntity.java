...
public class WitchOvenTileEntity extends LockableTileEntity implements ITickableTileEntity, IRecipeHolder, IRecipeHelperPopulator, ISidedInventory
{
	...
	{
		super(TileEntityTypesInit.WITCH_OVEN.get());
		...
		this.data = new IIntArray() 
		{
		 	public int get(int index) 
		 	{
		 		...
		 		{
			 		case 0:
			 			return WitchOvenTileEntity.this.burnTime;
			 		case 1:
			 			return WitchOvenTileEntity.this.fuelTime;
			 		case 2:
			 			return WitchOvenTileEntity.this.smeltTime;
			 		case 3:
			 			return WitchOvenTileEntity.this.smeltTimeTotal;
			 		default:
			 			return 0;
		 		}
		 	}
		 	...
		 	public void set(int index, int value) 
		 	{
		 		...
		 		{
			 		case 0:
			 			WitchOvenTileEntity.this.burnTime = value;
			 			break;
			 		case 1:
			 			WitchOvenTileEntity.this.fuelTime = value;
			 			break;
			 		case 2:
			 			WitchOvenTileEntity.this.smeltTime = value;
			 			break;
			 		case 3:
			 			WitchOvenTileEntity.this.smeltTimeTotal = value;
		 		}
		 	}
	...
	public void tick() 
	{
		...
		if (!this.world.isRemote) 
		{
			...
			{
				this.world.setBlockState(pos, world.getBlockState(pos).with(WitchOven.LIT, burning), 3);
				this.markDirty();
			}
		}
	}
